...
import emperitasHome from '../../assets/images/Emperitas/emperitas-home.png'
    ...
    return (
      <div>
        ...
        <div className="col-md-6 container skills d-flex align-items-center text-center rounded">
          ...
          <Slider slides={images} />
        <div className="col-md-6 container skills d-flex align-items-center text-center rounded">
          <h4 className="section-head">Formula By Dr. C</h4>
          <p>
            Shopify site for Utah Stem Cell's skincare line Formula By Dr. C. 
          </p>
          <br />
          <h6 className="skill-section">Technologies Used</h6>
          <p>
            Shopify
            <br /> Photoshop
          </p>
          ...
          <Slider slides={emperitasImg} />
        <div className="col-md-6 container skills d-flex align-items-center text-center rounded">
          <h4 className="section-head">Emperitas</h4>
          <p>
            Data, data, data. 
          </p>
          <br />
